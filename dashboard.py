...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Input(id='control-decay-rate', type='number', value=0.001),
        html.Br(),
        ...
        dcc.Input(id='monitor-bias-activation-rate', type='number', value=0.1),
        html.Span(style={'margin-right': '40px'}),
        ...
        dcc.Input(id='inhibition-rate', type='number', value=0.01),
        html.Span(style={'margin-right': '40px'}),
        ...
        dcc.Input(id='biasing-mult', type='number', value=0.000005),
        html.Br(),
